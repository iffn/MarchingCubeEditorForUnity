...
// NOTE:
//  Modified manually - Amplify editor will likely be broken
//  Added vertex color
Shader "BasicTerrainColorsAndVertexColors"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color3 = i.color;// IsGammaSpace() ? float4(0.1470054,0.3867925,0,0) : float4(0.01892627,0.1237993,0,0);
